...
import { t, handleError, roomTypes } from '/app/rocketchat-utils';
import { Messages, Rooms, Subscriptions } from '/app/rocketchat-models';
...
Meteor.startup(async function() {
	const { chatMessages } = await import('/app/rocketchat-ui');
