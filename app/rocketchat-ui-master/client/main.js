...
import { t, getUserPreference } from '/app/rocketchat-utils';
import { Session } from 'meteor/session';
import { Template } from 'meteor/templating';
import { mainReady, Layout, iframeLogin, modal, popover, menu, fireGlobalEvent } from '/app/rocketchat-ui-utils';
import { toolbarSearch } from '/app/rocketchat-ui-sidenav';
import { settings } from '/app/rocketchat-settings';
import { CachedChatSubscription, Roles, ChatSubscription } from '/app/rocketchat-models';
import { CachedCollectionManager } from '/app/rocketchat-ui-cached-collection';
import { hasRole } from '/app/rocketchat-authorization';
import { tooltip } from '/app/rocketchat-tooltip';
