...
export class CachedCollection {
	...
	async setupListener(eventType, eventName) {
		Meteor.startup(async() => {
			const { Notifications } = await import('/app/rocketchat-notifications');
			const { RoomManager } = await import('/app/rocketchat-ui-utils');
			const { ChatRoom, CachedChatRoom } = await import('/app/rocketchat-models');
