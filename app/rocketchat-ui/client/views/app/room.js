...
import { t, roomTypes, getUserPreference, handleError } from '/app/rocketchat-utils';
import { WebRTC } from '/app/rocketchat-webrtc';
import { ChatSubscription, ChatMessage, RoomRoles, Users, Subscriptions, Rooms } from '/app/rocketchat-models';
import {
	fireGlobalEvent,
	RoomHistoryManager,
	RoomManager,
	...
	MessageAction,
	RocketChatTabBar,
} from '/app/rocketchat-ui-utils';
import { settings } from '/app/rocketchat-settings';
import { callbacks } from '/app/rocketchat-callbacks';
import { promises } from '/app/rocketchat-promises';
import { hasAllPermission, hasRole } from '/app/rocketchat-authorization';
import _ from 'underscore';
import moment from 'moment';
import mime from 'mime-type/with-db';
import Clipboard from 'clipboard';
import { lazyloadtick } from '/app/rocketchat-lazy-load';
